<template>
  <div v-if="currentTutorial" class="edit-form py-3">
    ...
    <v-form ref="form" lazy-validation>
      ...
      <v-text-field v-model="currentTutorial.description" :rules="[(v) => !!v || 'Description is required']" label="Description" required></v-text-field>
      ...
      <v-btn v-else @click="updatePublished(true)" color="primary" small class="mr-2">Publish</v-btn>
